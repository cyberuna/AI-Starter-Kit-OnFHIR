...
* Click Sign in for Azure Active Directory Authentication. The connector also supports "Anonymous" for FHIR servers with no access controls.
* Select the resources you are interested in and click Transform.
